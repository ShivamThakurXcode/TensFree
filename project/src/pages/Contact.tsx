          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full px-4 py-2 border rounded-md bg-orange-950"
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center px-6 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-700"
            >
